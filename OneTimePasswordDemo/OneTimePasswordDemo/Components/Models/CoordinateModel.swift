...
class CoordinateModel: Codable {
    ...
    init(coordsQ1: [Coordinate], coordsQ2: [Coordinate], coordsQ3: [Coordinate], coordsQ4: [Coordinate]) {
        timeSerieQ1 = TimeSerieModel(with: coordsQ1)
        timeSerieQ2 = TimeSerieModel(with: coordsQ2)
        timeSerieQ3 = TimeSerieModel(with: coordsQ3)
        timeSerieQ4 = TimeSerieModel(with: coordsQ4)
    }
